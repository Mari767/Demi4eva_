//ЛАБОРАТОРНАЯ РАБОТА № 4 Одномерные динамические массивы и указатели
//Используя наработки ЛР №3 разбить проект на 2 функции(заполнение массива и задание по варианту) и файлы.Работать с динамическим массивом.

 //Дан массив из N целых чисел.Определить сумму элементов, расположенных между третьим с начала и третьим с конца массива.
...
int main() {
	...
	int Size_1;
	cout << "Введите размер массива. Размер массива не меньше 7 элементов" << endl;
	cin >> Size_1;
	if (Size_1 < 7) {
